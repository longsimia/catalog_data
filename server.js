...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .toc-actions{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;flex-wrap:nowrap}
    .toc-actions button{min-width:0;padding:8px 10px;font-size:14px;white-space:nowrap}
