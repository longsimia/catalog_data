...
<body>
  ...
  ${isTxt && canEditTxt ? `<script src="/vendor/txt-editor.js"></script><script>(()=>{const textarea=document.getElementById('editor'),host=document.getElementById('editorHost');if(textarea&&host&&typeof window.createTxtEditor==='function')window.txtEditorBridge=window.createTxtEditor(textarea,host);})();</script>` : ''}
  ${scrollMemoryScript}
