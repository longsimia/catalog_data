...
<body>
  ...
  ${isTxt && canEditTxt ? `<div class="modal" id="historyModal" aria-hidden="true"><div class="modal-bg" id="historyModalBg"></div><div class="modal-card history-modal-card" role="dialog" aria-modal="true" aria-labelledby="historyModalTitle"><h3 id="historyModalTitle">編輯記錄</h3><p>桌機可直接查看版本記錄；手機點擊版本後會開啟詳情。</p><div class="history-layout"><div class="history-list" id="historyList"></div><div class="history-inline-view"><div class="history-meta"><strong id="historyInlineVersionTitle">尚未選擇版本</strong><span id="historyInlineVersionMeta" class="diff-empty"></span></div><section class="history-record-pane"><div class="diff-head">版本記錄</div><div class="history-record-body" id="historyInlineVersionDiff"></div></section><div class="modal-actions" style="margin-top:0"><button type="button" id="historyInlineRestoreBtn">還原到此版本</button></div></div></div><div class="modal-actions"><button type="button" id="historyClearBtn">清空編輯記錄</button><button type="button" id="historyCloseBtn">關閉</button></div></div></div>` : ''}
