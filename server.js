...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .format-modal-card{width:min(90vw,380px)}
...
<body>
  ...
  ${isTxt ? `<script>(()=>{const previewEditor=document.getElementById('editor');function resizeEditor(){if(!previewEditor)return;previewEditor.style.height='auto';previewEditor.style.height=previewEditor.scrollHeight+'px';}resizeEditor();window.addEventListener('load',resizeEditor);window.addEventListener('resize',resizeEditor);previewEditor?.addEventListener('input',resizeEditor);})();</script>` : ''}
