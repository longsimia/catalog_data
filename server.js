...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .history-detail-modal-card{width:min(96vw,1080px)}
...
<body>
  ...
  ${isTxt && canEditTxt ? `<div class="modal" id="historyDetailModal" aria-hidden="true"><div class="modal-bg" id="historyDetailModalBg"></div><div class="modal-card history-detail-modal-card" role="dialog" aria-modal="true" aria-labelledby="historyDetailModalTitle"><h3 id="historyDetailModalTitle">編輯記錄詳情</h3><p>檢視選取版本與目前內容的差異。</p><div class="history-view"><div class="history-meta"><strong id="historyVersionTitle">尚未選擇版本</strong><span id="historyVersionMeta" class="diff-empty"></span></div><div class="history-diff"><section class="diff-pane"><div class="diff-head">選取的編輯記錄版本</div><div class="diff-body" id="historyVersionDiff"></div></section><section class="diff-pane"><div class="diff-head">目前內容</div><div class="diff-body" id="historyCurrentDiff"></div></section></div></div><div class="modal-actions"><button type="button" id="historyRestoreBtn">還原成此版本</button><button type="button" id="historyDetailCloseBtn">關閉</button></div></div></div>` : ''}
